...
#This section covers the Multi-Worm Tracker analysis of the Auxin treated PD1074 WT strain.
...
##Comand to read .smorph file in for 

setwd("/Volumes/DRSTRANGE/Lexi/Auxinmicropubdata/N2_PD1074_AUXIN_KNAA_0902_2020/data")
...
cleanrawsmorph$genotype <- factor(cleanrawsmorph$genotype,
    levels = c("PD1074_NGM", "PD1074_A25", "PD1074_A1"), ordered = TRUE)
...
##Remove ordering from genotype factor before statistical analysis. 

mean_cleanrawsmorph_filt$genotype <- factor(mean_cleanrawsmorph_filt$genotype,
    levels = c("PD1074_NGM", "PD1074_A25", "PD1074_A1"), ordered = FALSE)
...
```{r}
##Plots of mean reversal probability for PD1074 wild-type.
...
#This section covers the Multi-Worm Tracker analysis of the Auxin treated Rankin lab N2 WT strain. 
...
setwd("/Volumes/SAMWISE/Troy/N2_0.025mM_1mM_0923_2020/data")
...
cleanrawsmorph$genotype <- recode(cleanrawsmorph$genotype, `N2N` = "N2")
...
cleanrawsmorph$genotype <- factor(cleanrawsmorph$genotype,
    levels = c("N2", "N2A25", "N2A1"), ordered = TRUE)
...
mean_cleanrawsmorph_filt <- mean_cleanrawsmorph %>% 
  filter(genotype %in% c("N2", "N2A25", "N2A1"))
...
mean_cleanrawsmorph_filt$genotype <- factor(mean_cleanrawsmorph_filt$genotype,
    levels = c("N2", "N2A25", "N2A1"), ordered = FALSE)
...
cleanrawsrev$genotype <- recode(cleanrawsrev$genotype, `N2N` = "N2")
...
```{r}
##Plots of mean reversal probability for N2 Wild-type controls
